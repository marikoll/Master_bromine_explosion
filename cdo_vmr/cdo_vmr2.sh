...
# (tropospheric tracers 3-hour output)
#
# Activate shell script by typing: chmod +x cdo_vmr2.sh
#------------------------------------------------------------------
...
for infile1 in `ls ${srcdir}*.nc` ; do
    ...
    if [[ ! -e ${outfile} ]]; then
	    ...
	    cdo -L mulc,$Mair -divc,$MCH4 -div -sellevidx,1 -selname,CH4 ${infile1} -selname,air_densit ${infile2} ${outfile}
	    ...
	    #cdo -L mulc,$Mair -divc,$MO3 -div -selname,O3 ${infile1} -selname,air_densit ${infile2} ${outfile}
            cdo -L mulc,$Mair -divc,$MCH4 -div -selname,CH4 ${infile1} -selname,air_densit ${infile2} ${outfile}
        ...
        # Rename variable
	ncrename -v .air_densit,"CH4" ${outfile}
